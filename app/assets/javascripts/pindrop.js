...
(function($,doc){
  var promo_objects = [];
  var myfangate_url = location.pathname; // "//myfangate.com/ci/";
    ...
    'create'  : function(o, element){
      ...
      self  = {
        ...
        'track_event' : function(action, label, value, noninteraction){
          ...
          window._gaq.push(["_trackEvent", $.capitaliseFirstLetter(o.ga_category), $.capitaliseFirstLetter(action), $.capitaliseFirstLetter(label), value, noninteraction]);
          return true;
        },
